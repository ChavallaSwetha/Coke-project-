		...
		for (int r = 0; r < rowsXL; r++) {
			if ((kpiXL[r]).equals(mpa)) {
				...
				if (pID.equals(withOutCooler)) {
					...
					Label mpaAdd = new Label(5, 13, mpaSt);
				...
				Label resultAdd = new Label(6, 13, result);
				...
				if (pID.equals(withOutCooler)) {
					...
					writeSh.addCell(channelAdd);
					Label soviAdd = new Label(5, 14, soviSt);
				...
				Label resultAdd = new Label(6,14, result);
				writeSh.addCell(resultAdd);
				...
				if (pID1.equals(withOutCooler)) {
					...
					writeSh.addCell(channelAdd);
					Label refAdd = new Label(5,15, refSt);
				...
				Label resultAdd = new Label(6,15, result);
				writeSh.addCell(resultAdd);
				...
				if (pID1.equals(withOutCooler)) {
					...
					writeSh.addCell(channelAdd);
					Label communionAdd = new Label(5, 16, commexSt);
				...
				Label resultAdd = new Label(6, 16, result);
				writeSh.addCell(resultAdd);
				...
				if (pID1.equals(withOutCooler)) {
					...
					writeSh.addCell(channelAdd);
					Label priceAdd = new Label(5, 17, priceSt);
				...
				Label resultAdd = new Label(6, 17, result);
				writeSh.addCell(resultAdd);
				...
				writeSh.addCell(channelAdd);
				Label totalAdd = new Label(5,18, total);
			...
			Label resultAdd = new Label(6, 18, result);
			writeSh.addCell(resultAdd);
		}
	}
