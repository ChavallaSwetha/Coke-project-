...
public class PremiseWithAndWithOutCooler {
     
	public void compareCountryLevelCoolerData(WritableSheet writeSheet, String readFilePath, String

			date, int i, UIAndXLCountryLevelData uiData1, UIAndXLCountryLevelData xldata)
				...
				Label counTry3 = new Label(0, 2, xldata.getCOUNTRY());
				writeSheet.addCell(counTry3);
				Label daTe3 = new Label(1, 2, date);
				writeSheet.addCell(daTe3);
				Label chaNNel3 = new Label(2, 2, xldata.getCHANNEL());
				writeSheet.addCell(chaNNel3);
				Label piDfromXL3 = new Label(4, 2, xldata.getPID());
				writeSheet.addCell(piDfromXL3);
				Label iCEXL3 = new Label(5, 2, String.valueOf(xldata.getREF()));
				writeSheet.addCell(iCEXL3);
				Label kpI3 = new Label(3, 2, xldata.getKPIref());
				writeSheet.addCell(kpI3);
				Label mpaFromUI3 = new Label(6, 2, String.valueOf(uiData1.getREF()));
				...
				writeSheet.addCell(result);
				Label counTry4 = new Label(0, 3, xldata.getCOUNTRY());
				writeSheet.addCell(counTry4);
				Label daTe4 = new Label(1, 3, date);
				writeSheet.addCell(daTe4);
				Label chaNNel4 = new Label(2, 3, xldata.getCHANNEL());
				writeSheet.addCell(chaNNel4);
				Label piDfromXL4 = new Label(4, 3, xldata.getPID());
				writeSheet.addCell(piDfromXL4);
				Label iCEXL4 = new Label(5, 3, String.valueOf(xldata.getCOMM()));
				writeSheet.addCell(iCEXL4);
				Label kpI4 = new Label(3, 3, xldata.getKPIcomm());
				writeSheet.addCell(kpI4);
				Label mpaFromUI4 = new Label(6, 3, String.valueOf(uiData1.getCOMM()));
				...
				writeSheet.addCell(result);
				Label counTry5 = new Label(0, 4, xldata.getCOUNTRY());
				writeSheet.addCell(counTry5);
				Label daTe5 = new Label(1, 4, date);
				writeSheet.addCell(daTe5);
				Label chaNNel5 = new Label(2, 4, xldata.getCHANNEL());
				writeSheet.addCell(chaNNel5);
				Label piDfromXL5 = new Label(4, 4, xldata.getPID());
				writeSheet.addCell(piDfromXL5);
				Label iCEXL5 = new Label(5, 4, String.valueOf(xldata.getPRICE()));
				writeSheet.addCell(iCEXL5);
				Label kpI5 = new Label(3, 4, xldata.getKPIprice());
				writeSheet.addCell(kpI5);
				Label mpaFromUI5 = new Label(6, 4, String.valueOf(uiData1.getPRICE()));
				...
				writeSheet.addCell(result);
				Label counTry6 = new Label(0, 5, xldata.getCOUNTRY());
				writeSheet.addCell(counTry6);
				Label daTe6 = new Label(1, 5, date);
				writeSheet.addCell(daTe6);
				Label chaNNel6 = new Label(2, 5, xldata.getCHANNEL());
				writeSheet.addCell(chaNNel6);
				Label piDfromXL6 = new Label(4, 5, xldata.getPID());
				writeSheet.addCell(piDfromXL6);
				Label iCEXL6 = new Label(5, 5, String.valueOf(xldata.getFRESH()));
				writeSheet.addCell(iCEXL6);
				Label kpI6 = new Label(3, 5, xldata.getKPIfresh());
				writeSheet.addCell(kpI6);
				Label mpaFromUI6 = new Label(6, 5, String.valueOf(uiData1.getFRESH()));
				...
				writeSheet.addCell(result);
				Label counTry7 = new Label(0, 6, xldata.getCOUNTRY());
				writeSheet.addCell(counTry7);
				Label daTe7 = new Label(1, 6, date);
				writeSheet.addCell(daTe7);
				Label chaNNel7 = new Label(2, 6, xldata.getCHANNEL());
				writeSheet.addCell(chaNNel7);
				Label piDfromXL7 = new Label(4, 6, xldata.getPIDT());
				writeSheet.addCell(piDfromXL7);
				Label iCEXL7 = new Label(5, 6, String.valueOf(xldata.getTOTAL()));
				writeSheet.addCell(iCEXL7);
				Label kpI7 = new Label(3, 6, xldata.getKPItotal());
				writeSheet.addCell(kpI7);
				System.out.println("7th row" + "   " + xldata.getKPItotal());
				Label mpaFromUI7 = new Label(6, 6, String.valueOf(uiData1.getTOTAL()));
				writeSheet.addCell(mpaFromUI7);
				float diffBetweentotalUIICEAndIceValueXL7 = Math.abs(xldata.getTOTAL() -
